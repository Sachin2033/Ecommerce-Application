...
public class ProductServiceImplementation implements ProductService{
	...
	public Product createProduct(CreateProductRequest req) {
		...
		Category topLevel= categoryRepository.
				findByName(req.getTopLavelCategory());
		if(topLevel==null) {
		...
		Category thirdLevel= categoryRepository.
				findByNameAndParent(req.getThirdLavelCategory() , secondLevel.getName());
...
//		List<Product>
	...
	public Page<Product> getAllProducts(String category, List<String> colors, List<String> sizes, Integer minPrice,
		...
		} //// any color matches from the list so product will be added to the list
